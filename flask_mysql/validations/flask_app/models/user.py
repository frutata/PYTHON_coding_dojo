...
#=======================
    ...
    def validate_register(form_data):
        ...
        if form_data['age'] == "":
            ...
            flash('*MUST be at least 18 years or older to create an account!')
            is_valid = False
...
#=======================
    ...
    def register_user(cls, data):
        query = ' INSERT INTO users (first_name, last_name, email, age, password, created_at) VALUES (%(first_name)s, %(last_name)s, %(email)s, %(age)s, %(password)s, NOW());'
